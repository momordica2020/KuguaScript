...
public partial class KuguaScriptLexer : Lexer {
	...
	public KuguaScriptLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public KuguaScriptLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
